"use strict";(()=>{var e={};e.id=9692,e.ids=[9692],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},35702:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>h,patchFetch:()=>b,requestAsyncStorage:()=>g,routeModule:()=>u,serverHooks:()=>m,staticGenerationAsyncStorage:()=>y});var r={};o.r(r),o.d(r,{POST:()=>f});var i=o(49303),s=o(88716),n=o(60670),a=o(87070),p=o(84770),d=o(20471);let l="https://ccoms.ph/api-bridge.php";async function c(e,t){let o=new URL(l);return o.searchParams.set("table",e),(await fetch(o.toString(),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}async function x(e,t={}){let o=new URL(l);return o.searchParams.set("table",e),Object.entries(t).forEach(([e,t])=>o.searchParams.set(e,t)),(await fetch(o.toString(),{cache:"no-store"})).json()}async function f(e){let{client_id:t,temp_password:o}=await e.json();if(!t)return a.NextResponse.json({error:"client_id required"},{status:400});let r=await fetch(`${l}?action=client-approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({client_id:t,temp_password:o})}),i=await r.json();if(i.error)return a.NextResponse.json({error:i.error},{status:500});let s=await x("clients",{"eq[id]":t}),n=s.data?.[0];if(n){let e=process.env.NEXT_PUBLIC_SITE_URL||"http://localhost:3000";await c("client_notifications",{id:(0,p.randomUUID)(),client_id:t,type:"payment_verified",message:`Welcome to Core Conversion! Your account (${i.client_id}) is now active. Please complete your onboarding form.`,link:"/client-dashboard/intake"});let r=`
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
        ...
        <div style="background:#f9fafb;padding:32px;border:1px solid #e5e7eb;border-top:none">
          <p style="color:#374151;margin:0 0 20px">Hi <strong>${n.name}</strong>,</p>
          ...
          <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:20px;margin:20px 0">
            <table style="width:100%;font-size:14px">
              <tr><td style="color:#6b7280;padding:4px 0;width:140px">Client ID</td><td style="font-weight:700;color:#111">${i.client_id}</td></tr>
              <tr><td style="color:#6b7280;padding:4px 0">Email</td><td style="color:#111">${n.email}</td></tr>
              <tr><td style="color:#6b7280;padding:4px 0">Temp Password</td><td style="font-family:monospace;font-weight:700;color:#1e40af">${o}</td></tr>
            </table>
          </div>
          <p style="color:#ef4444;font-size:13px;margin:0 0 20px">⚠️ Please change your password after your first login.</p>
          <a href="${e}/client-dashboard/login" style="display:inline-block;background:#1e40af;color:#fff;padding:14px 28px;border-radius:8px;font-weight:700;text-decoration:none;font-size:15px">
            Access Your Portal →
          </a>
      ...
      </div>`;(0,d.Yb)({to:n.email,subject:`✅ Payment Verified — Welcome to Core Conversion (${i.client_id})`,html:r}).catch(e=>console.error("[welcome email]",e))}return a.NextResponse.json({success:!0,client_id:i.client_id,temp_password:o})}let u=new i.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/clients/approve/route",pathname:"/api/clients/approve",filename:"route",bundlePath:"app/api/clients/approve/route"},resolvedPagePath:"/Users/abrahampaulcarrasco/Desktop/ccoms/src/app/api/clients/approve/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:g,staticGenerationAsyncStorage:y,serverHooks:m}=u,h="/api/clients/approve/route";function b(){return(0,n.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:y})}},20471:(e,t,o)=>{o.d(t,{DH:()=>l,Hw:()=>c,NY:()=>a,Yb:()=>n,bj:()=>d,fO:()=>p});var r=o(55245);let i=null;async function s(){if(i)return i;if(process.env.SMTP_USER&&process.env.SMTP_PASS)i=r.createTransport({host:process.env.SMTP_HOST||"smtp.hostinger.com",port:Number(process.env.SMTP_PORT)||465,secure:"false"!==process.env.SMTP_SECURE,auth:{user:process.env.SMTP_USER,pass:process.env.SMTP_PASS}});else{let e=await r.createTestAccount();i=r.createTransport({host:"smtp.ethereal.email",port:587,secure:!1,auth:{user:e.user,pass:e.pass}}),console.log("[email] Using Ethereal test account:",e.user)}return i}async function n({to:e,subject:t,html:o,text:i}){let n=await s(),a=`"${process.env.FROM_NAME||"Core Conversion"}" <${process.env.SMTP_USER||"support@ccoms.ph"}>`,p=await n.sendMail({from:a,to:e,subject:t,html:o,text:i||o.replace(/<[^>]+>/g,"")});return process.env.SMTP_PASS||console.log("[email] Preview URL:",r.getTestMessageUrl(p)),p}async function a({subject:e,html:t}){return n({to:process.env.ADMIN_EMAIL||"paul@ccoms.ph",subject:e,html:t})}function p(e){return`
    <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
    ...
    </div>`}}};var t=require("../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[9276,5972,5245],()=>o(35702));module.exports=r})();